...
SP_atom SPCDECL _Sget_functor(char *pointer)
{
  return ((SP_atom *)(pointer))[-1];
}


SP_atom SPCDECL _Sget_atom(char *pointer, SP_integer offset)
{
...
SP_integer SPCDECL _Sget_integer(char *pointer, SP_integer offset)
{
	return *(SP_integer *)(pointer+offset);
}


SP_integer SPCDECL _Sget_integer_32(char *pointer, SP_integer offset)
{
	return *(int *)(pointer+offset);
}


SP_integer SPCDECL _Sget_integer_16(char *pointer, SP_integer offset)
{
	return *(short *)(pointer+offset);
}


SP_integer SPCDECL _Sget_integer_8(char *pointer, SP_integer offset)
{
	return *(signed char *)(pointer+offset); /* char can be unsigned! */
}


SP_integer SPCDECL _Sget_unsigned(char *pointer, SP_integer offset, SP_integer *mask)
{
        *mask = SIGNMASK;
...
SP_integer SPCDECL _Sget_unsigned_32(char *pointer, SP_integer offset, SP_integer *mask)
{
        *mask = SIGNMASK;
...
SP_integer SPCDECL _Sget_unsigned_16(char *pointer, SP_integer offset)
{
	return *(unsigned short *)(pointer+offset);
}


SP_integer SPCDECL _Sget_unsigned_8(char *pointer, SP_integer offset)
{
	return *(unsigned char *)(pointer+offset);
}


double SPCDECL _Sget_float_32(char *pointer, SP_integer offset)
{
	return *(float *)(pointer+offset);
}


double SPCDECL _Sget_float(char *pointer, SP_integer offset)
{
	return *(double *)(pointer+offset);
}


void SPCDECL _Sput_atom(char *pointer, SP_integer offset, SP_atom newvalue)
{
	/*
...
void SPCDECL _Sput_integer_32(char *pointer, SP_integer offset, SP_integer newvalue)
{
	(*(int *)(pointer+offset)) = newvalue;
}

void SPCDECL _Sput_integer_16(char *pointer, SP_integer offset, SP_integer newvalue)
{
	(*(short *)(pointer+offset)) = (short)newvalue;
}

void SPCDECL _Sput_integer_8(char *pointer, SP_integer offset, SP_integer newvalue)
{
	(*(char *)(pointer+offset)) = (char)newvalue;
}

/* the next four are in fact identical to the signed versions */
void SPCDECL _Sput_unsigned(char *pointer, SP_integer offset, SP_integer newvalue)
{
	(*(SP_integer *)(pointer+offset)) = newvalue;
}

void SPCDECL _Sput_unsigned_32(char *pointer, SP_integer offset, SP_integer newvalue)
{
	(*(int *)(pointer+offset)) = newvalue;
}

void SPCDECL _Sput_unsigned_16(char *pointer, SP_integer offset, SP_integer newvalue)
{
	(*(short *)(pointer+offset)) = (short)newvalue;
}

void SPCDECL _Sput_unsigned_8(char *pointer, SP_integer offset, SP_integer newvalue)
{
	(*(char *)(pointer+offset)) = (char)newvalue;
}

void SPCDECL _Sput_float_32(char *pointer, SP_integer offset, double newvalue)
{
	(*(float *)(pointer+offset)) = (float)newvalue;
}

void SPCDECL _Sput_float(char *pointer, SP_integer offset, double newvalue)
{
