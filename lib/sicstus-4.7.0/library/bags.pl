...
%@  recognizes proper well-formed bags.  You can pass variables to @code{is_bag/1},
...
%   generalizes bag_{max,min}/2.  They share a common routine, at a small
...
%   generalizes bag_{max,min}/3.  They share a common routine, at a small
%   cost in efficiency, to make it impossible for them to break ties
%   differently.
