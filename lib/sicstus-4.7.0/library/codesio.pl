...
:- format_to_codes/3 is det.
format_to_codes(Fmt, Args, Codes) :-
	format_to_codes(Fmt, Args, Codes, []).

:- format_to_codes/4 is documented_as(format_to_codes/3).
:- format_to_codes/4 is det.
...
%@  respectively.
:- write_to_codes/2 is det.
write_to_codes(Term, Codes) :-
	write_to_codes(Term, Codes, []).

:- write_to_codes/3 is documented_as(write_to_codes/2).
:- write_to_codes/3 is det.
...
:- write_term_to_codes/3 is det.
write_term_to_codes(Term, Codes, Options) :-
	write_term_to_codes(Term, Codes, [], Options).


:- write_term_to_codes/4 is documented_as(write_term_to_codes/3).
:- write_term_to_codes/4 is det.
...
%@  writing.
:- with_output_to_codes/2 is semidet.
with_output_to_codes(Goal, Codes) :-
	with_output_to_codes(Goal, Codes, []).


:- with_output_to_codes/3 is documented_as(with_output_to_codes/2).
:- with_output_to_codes/3 is semidet.
with_output_to_codes(Goal, S0, S) :-
	with_output_to_codes(Goal, _, S0, S).


:- with_output_to_codes/4 is documented_as(with_output_to_codes/2).
:- with_output_to_codes/4 is semidet.
