...
public interface Prolog {
     ...
     * {@link se.sics.jasper.Query#nextSolution nextSolution} to do that. When no
     * more solutions are needed, the query must be closed using methods
     * {@link se.sics.jasper.Query#close close} or {@link se.sics.jasper.Query#cut
     * cut} on the query-object.
     * 
     * <p>
     * 
     ...
     *            <p>
     *            The passed argument should be a {@code Map<String,Term>}. It uses
     ...
     *
     */
    Query openPrologQuery(String string, Map<String, ? extends Term> varMap)
     ...
     * than one solution, use {@link se.sics.jasper.Prolog#openPrologQuery
     * openPrologQuery}.
     * 
     * @param string
     *            The goal to use for the query, with terminating period.
     ...
     */
    boolean query(String string, Map<String, ? extends Term> varMap)
            throws NoSuchMethodException, InterruptedException, Exception;
     ...
     *
     */
    boolean queryCutFail(String string, Map<String, ? extends Term> varMap)
            throws NoSuchMethodException, InterruptedException, Exception;
     ...
     * Term does not affect the input Term.
     * 
     * @param t
     ...
     *             some other problem happened
     */
    Term prologReadFromString(String string, Map<String, ? extends Term> varMap) throws InterruptedException, Exception;
